...
const francoEg: Dict = {
  ...
  contact: {
    ...
    sub: '2olelna 3an shoghlak w hanraddelak khelal youm shoghl wahed.',
    addr: 'Dubai, UAE',
    sent: 'El resala et-ba3atit.',
    sentSub: 'Hanetwasalak khelal youm shoghl wahed. 3ayez tetkallem delwa2ty? Raslna 3ala WhatsApp.',
    sentCta: 'Raslna 3ala WhatsApp',
    name: 'El esm', namePh: 'Esmak el kamel',
    business: 'Esm el nashat', businessPh: 'El sherka / el brand',
    phone: 'El telefon',
    email: 'El email', emailPh: 'you@company.com',
    country: 'El balad',
    industry: 'El sector',
    budget: 'El mizaneya el shahreya', budgetPh: 'Ekhtar range',
    message: 'El resala', optional: '(ekhteyari)', messagePh: '2olelna 3an ahdafak...',
    whatsappOk: 'Tamam ekallemni 3ala WhatsApp.',
    submit: 'Eb3at el resala',
    submitting: 'Bet-eb3at...',
    errors: {
      name: 'El esm matloob',
      business: 'Esm el nashat matloob',
      phone: 'El telefon matloob',
      email: 'Email ghalat',
      budget: 'Ekhtar mizaneya',
      generic: 'Kholla2 shoof el form.',
      send: '7asal khata2. Jarrab tany aw raslna 3ala WhatsApp.',
    },
    countries: { UAE: 'El Emarat', Egypt: 'Masr', Other: 'Haga tanya' },
    industries: { 'Real Estate': 'Real Estate', 'E-commerce': 'E-commerce', Other: 'Haga tanya' },
    budgets: ['A2al men $1,000', '$1,000 – $3,000', '$3,000 – $6,000', '$6,000 – $12,000', '+$12,000'],
  },
  footer: {
