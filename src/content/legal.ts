    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'لتشغيل حسابك ذاتي الخدمة، وتوليد واستضافة أقماعك، وعرض العملاء والزيارات التي تحصل عليها.',
      ...
      },
      {
        ...
        body: [
          'يمكن أن يعمل المنتج ذاتي الخدمة في وضع عرض بدون نظام حسابات حقيقي، وفي هذه الحالة يُخزَّن حسابك وأقماعك وعملاؤك فقط في التخزين المحلي لمتصفّحك ولا تُرسَل إلى خوادمنا أبداً. عند تفعيل نظام مصادقة حقيقي وقاعدة بيانات، تُخزَّن بياناتك بدلاً من ذلك بأمان على خوادمنا ولا يصل إليها إلا أنت، وفريقك إن فعّلت ذلك صراحةً.',
        ],
      },
      {
        heading: 'ملفات تعريف الارتباط والتخزين المحلي',
        body: [
          'نستخدم التخزين المحلي للمتصفّح لإبقائك مسجّلاً للدخول ولتخزين أقماعك وإعداداتك في وضع العرض. لا نستخدم حالياً ملفات تعريف ارتباط إعلانية أو تتبّعية من طرف ثالث على موقعنا التسويقي أو منتجنا ذاتي الخدمة.',
